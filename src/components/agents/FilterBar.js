...
export default function FilterBar({ filter, setFilter, agents, favorites }) {
  ...
  return (
    <div className="w-full overflow-x-auto scrollbar-hide mb-4 sm:mb-8 relative z-50 px-2 sm:px-0">
      <div
        className="inline-flex flex-nowrap gap-1 sm:gap-2 py-1 sm:py-2 items-center bg-white/10 backdrop-blur-lg rounded-xl shadow-lg border border-blue-400/20"
        style={{
          minHeight: "36px",
