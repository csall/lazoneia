      ...
      <main className="pt-8 px-4 pb-12 max-w-7xl mx-auto font-sans">
        ...
        {!connected && (
          <div className="relative p-8 rounded-2xl border-2 border-violet-400/40 dark:border-fuchsia-500/30 bg-gradient-to-br from-white/80 via-violet-50/80 to-fuchsia-50/80 dark:from-violet-900/60 dark:via-fuchsia-900/40 dark:to-violet-950/60 backdrop-blur-xl flex flex-col items-center gap-6 max-w-xl mx-auto shadow-xl animate-[pulseGlow_2.5s_ease-in-out_infinite] overflow-hidden">
            <div className="absolute -inset-1 rounded-3xl pointer-events-none z-0 bg-gradient-to-br from-fuchsia-400/30 via-violet-400/20 to-transparent blur-2xl opacity-60 animate-[glowMove_6s_linear_infinite]"></div>
            ...
            >
              <span className="inline-block w-6 h-6 animate-spin-slow">
                <svg viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <g filter="url(#glow)">
                    <path d="M44.5 20H24V28.5H36.5C35.2 33.1 30.9 36.5 24 36.5C16.6 36.5 10.5 30.4 10.5 23C10.5 15.6 16.6 9.5 24 9.5C27.2 9.5 30.1 10.7 32.3 12.7L38.1 7C34.4 3.7 29.5 1.5 24 1.5C11.8 1.5 1.5 11.8 1.5 24C1.5 36.2 11.8 46.5 24 46.5C36.2 46.5 46.5 36.2 46.5 24C46.5 22.6 46.4 21.3 46.2 20H44.5Z" fill="#FFC107" />
                    <path d="M6.3 14.1L13.2 19.1C15.1 14.7 19.2 11.5 24 11.5C26.6 11.5 29 12.4 30.9 13.9L37.1 8.1C33.6 4.9 29 2.5 24 2.5C15.2 2.5 7.7 8.7 6.3 14.1Z" fill="#FF3D00" />
                    <path d="M24 45.5C30.7 45.5 36.5 41.2 39.1 35.5L31.7 30.1C30.1 31.1 27.9 32.5 24 32.5C19.2 32.5 15.1 29.3 13.2 24.9L6.3 29.9C7.7 35.3 15.2 41.5 24 45.5Z" fill="#4CAF50" />
                    <path d="M46.5 24C46.5 22.6 46.4 21.3 46.2 20H44.5V20H24V28.5H36.5C35.6 31.7 32.7 34.5 29.1 35.5L36.5 40.9C40.1 37.7 46.5 31.5 46.5 24Z" fill="#1976D2" />
                  </g>
                  <defs>
                    <filter id="glow" x="-2" y="-2" width="52" height="52" filterUnits="userSpaceOnUse" colorInterpolationFilters="sRGB">
            ...
            <style jsx global>{`
            @keyframes pulseGlow {
              0%,100% { box-shadow: 0 0 0 0 #f0abfc44, 0 0 32px 8px #a78bfa33; }
              50% { box-shadow: 0 0 0 8px #f0abfc33, 0 0 48px 16px #a78bfa55; }
            }
            @keyframes glowMove {
              0% { transform: translateY(0) scale(1); opacity: 0.6; }
              50% { transform: translateY(-10px) scale(1.04); opacity: 0.8; }
