    ...
    <main className="min-h-screen bg-gradient-to-r from-blue-900 to-purple-900 animate-gradient-x text-white font-sans">
      <section className="relative py-6 text-center px-4 overflow-hidden">
        ...
        <div className="container mx-auto mb-12 relative">
          ...
          <div className="w-full overflow-x-auto scrollbar-hide mb-6 sm:mb-8 relative z-50 px-2 sm:px-0">
            <div className="inline-flex flex-nowrap gap-2 px-4 py-2 items-center bg-white/10 backdrop-blur-lg rounded-xl shadow-lg border border-blue-400/20"
              style={{
                minHeight: '44px',
                scrollSnapType: 'x mandatory',
                WebkitOverflowScrolling: 'touch',
                paddingLeft: 'clamp(0.5rem, 4vw, 2rem)',
                paddingRight: 'clamp(0.5rem, 4vw, 2rem)'
              }}>
              {/* Spacer to ensure left visibility on small screens */}
