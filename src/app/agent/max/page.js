    ...
    <main className="min-h-screen bg-gradient-to-r from-blue-900 to-sky-900 text-white">
      ...
      <div className="container mx-auto px-4 py-4">
        <div className="flex flex-col md:flex-row gap-4 items-center mb-6">
          ...
          >
            ...
            <p className="text-sm md:text-base text-blue-200 max-w-xl">
              Partagez vos données et je vous fournirai des insights stratégiques.
            </p>
          </motion.div>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          >
            <h2 className="text-lg font-bold mb-2">Votre demande d&apos;analyse</h2>
          ...
          >
            <h2 className="text-lg font-bold mb-2">Analyse de Max</h2>
            {isLoading ? (
              <div className="flex-1 flex flex-col items-center justify-center">
                <div className="animate-spin rounded-full h-8 w-8 border-b-2 border-white"></div>
                <p className="mt-2 text-blue-200 text-sm">Max analyse vos données...</p>
              </div>
            ) : response ? (
              <div className="flex flex-col space-y-3">
                <div className="bg-blue-900/30 rounded-lg p-3 border border-blue-700/30 flex-1">
                  <p className="whitespace-pre-wrap text-blue-100 text-sm">{response}</p>
                </div>
                
                {dataPreview && (
                  <div className="bg-blue-900/30 rounded-lg p-3 border border-blue-700/30">
                    <h3 className="text-base font-semibold mb-2">Aperçu des données</h3>
              ...
              <div className="flex-1 flex flex-col items-center justify-center text-blue-300/70">
                ...
                <p className="text-sm">L&apos;analyse de Max apparaîtra ici</p>
              </div>
            )}
          </motion.div>
        </div>
