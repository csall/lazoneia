...
export default function CharmPage() {
  ...
  return (
    <>
      <div className="flex justify-end items-center w-full fixed top-0 left-0 right-0 z-40 px-4 py-4 bg-gradient-to-b from-blue-900/80 to-transparent backdrop-blur-sm">
        <GoogleMenu />
      </div>
      <main className="min-h-screen bg-gradient-to-r from-pink-900 to-rose-800 text-white">
        ...
        <div className="container mx-auto px-4 py-4">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            >
              <h2 className="text-lg font-bold mb-2">Réponse de Charm</h2>
              {isLoading ? (
                <div className="flex-1 flex flex-col items-center justify-center">
                  <div className="animate-spin rounded-full h-8 w-8 border-b-2 border-white"></div>
                  <p className="mt-2 text-pink-200 text-sm">Charm prépare une réponse irrésistible...</p>
                </div>
              ) : response ? (
                ...
                <div className="flex-1 flex flex-col items-center justify-center text-pink-300/70">
                  ...
                  <p className="text-sm">La réponse de Charm apparaîtra ici</p>
                </div>
              )}
            </motion.div>
          </div>
