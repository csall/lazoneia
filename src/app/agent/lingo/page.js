        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          >
            ...
            {isLoading ? (
              ...
              <div className="bg-amber-900/30 rounded-lg p-3 border border-amber-700/30 h-full">
                <p className="whitespace-pre-wrap text-amber-100 text-sm">{response}</p>
                <div className="mt-3 text-right">
                  <button 
                    className="text-xs text-amber-300 hover:text-white transition bg-amber-800/50 px-2 py-1 rounded-lg"
